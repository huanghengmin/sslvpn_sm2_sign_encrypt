...
//        sb.append("resolv-retry infinite" ).append("\n");
        ...
        //国密相关配置
        sb.append("tls-version-max  gm1.1").append("\n");
        sb.append("enc-key client.key").append("\n");
        sb.append("extra-certs client.crt").append("\n");
        //加密tls文件
    ...
    public static void configServer(Server server, String server_file_path) throws Exception {
        ...
        //国密相关配置
        sb.append("enc-key " + X509Context.encrypt_key_file).append("\n");
        sb.append("extra-certs " + X509Context.encrypt_server_file).append("\n");
        sb.append("tls-version-max " + "gm1.1").append("\n");
